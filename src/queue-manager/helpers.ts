import { DbQueueMetrics, Queue, QueueMetrics } from "./types.ts";
...
export const parseDbQueueMetrics = (m: DbQueueMetrics): QueueMetrics => ({
	...
	newestMsgAgeSec:
		m.newest_msg_age_sec != null ? parseInt(m.newest_msg_age_sec) : undefined,
	oldestMsgAgeSec:
		m.oldest_msg_age_sec != null ? parseInt(m.oldest_msg_age_sec) : undefined,
